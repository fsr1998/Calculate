package calculate.thunderup0.example.com.calculate;
...
public class CalculateActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); //实例化对象
        ...
        et_input= (EditText) findViewById(R.id.et_input); //设置按钮的点击事件
    ...
    private void getResult() {
        ...
        clr_flag = true; //截取运算符前面的字符串
        String s1 = exp.substring(0, exp.indexOf(" ")); //截取的运算符
        String op = exp.substring(exp.indexOf(" ") + 1, exp.indexOf(" ") + 2); //截取运算符后面的字符串
